...
void hbpTest()
{
  ...
  unsigned long time0, time1, time2 = 0, time3 = 0, time4 = 0, time5 = 0, tmp1, tmp2;
  ...
  for(int i=0; i<n; i++) {
    ...
    tmp2 = millis(); time5 += tmp2-tmp1;

  }

  Serial.print("Candidate Key generation: ");
  Serial.println(time0);
  Serial.print("Precompute Noise Array: ");
